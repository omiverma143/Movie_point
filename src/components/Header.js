...
export const Header = () => {
  ...
  function handleSearchSubmit(event) {
    ...
    const searchparams = event.target.search.value;
    console.log(searchparams);
    event.target.reset();
    return navigate(`search?q=${searchparams}`);
  }
        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id="mobile-nav" className="flex md:order-2">
            <button
              ...
              type="button"
              className="mx-4 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1 "
            >
              {darkmode ? (
                <svg
